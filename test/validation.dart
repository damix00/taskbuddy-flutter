...
void main() {
  ...
  group('username validation', () {
    ...
    test('Confirm valid usernames', () {
      for (var username in validUsernames) {
        expect(Validators.isUsernameValid(username), true);
      }
    });

    test('Detect invalid usernames', () {
      for (var username in invalidUsernames) {
        expect(Validators.isUsernameValid(username), false);
      }
    });
  });
}
